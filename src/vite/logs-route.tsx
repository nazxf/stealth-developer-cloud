...
import { BrowserAPIError, browserAPI, type BrowserOrganizationAuditEvent, type BrowserTrace } from "@/lib/browser-api";
...
export default function LogsRoute() {
  ...
  async function loadMoreTraces() {
    ...
    try {
      ...
      setTraceLoadError(error instanceof BrowserAPIError ? error.message : "Unable to load more request traces.");
    } finally {
