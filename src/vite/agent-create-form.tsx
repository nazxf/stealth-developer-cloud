...
export const agentRoles: BrowserAgentRole[] = ["General", "Frontend", "Reviewer", "Documentation"];
export const agentTools: BrowserAgentTool[] = ["Read files", "Search code", "Edit files", "Terminal", "Run tests", "Git diff"];
...
export function AgentCreateForm({ projects, onClose }: { projects: AgentProjectOption[]; onClose: () => void }) {
  ...
  const [selectedTools, setSelectedTools] = useState<BrowserAgentTool[]>([...agentTools]);
