...
const projectLogsRoute = createRoute({ getParentRoute: () => rootRoute, path: "/projects/$projectId/logs", component: lazyRouteComponent(() => import("./logs-route")) });
